...
const createClient = ({ tunnelHost, countryCode, }) => {
    const tunnelPort = constants_1.COUNTRY_CODE_CLIENTS_PROXY_PORT_MAPPING[countryCode];
    logger_1.default.log(`Client Server will proxy encrypted packets to ${tunnelHost}:${tunnelPort}`);
